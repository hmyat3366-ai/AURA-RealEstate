  ...
  return (
    <>
      ...
      <section className="bg-white py-6 px-8 border-b">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-4">
          ...
          <Link to="/neighborhoods/texas">
            <button className="bg-agency-navy text-white px-6 py-3 rounded-md font-semibold text-sm">Texas</button>
          </Link>
      ...
      <section className="relative h-[500px] overflow-hidden">
        <img alt="Texas Landscape" className="w-full h-full object-cover" src="/region-texas.jpg" />
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <h1 className="text-white text-8xl md:text-9xl font-bold tracking-tight select-none">Texas</h1>
        </div>
      </section>
      {/*  END: HeroSection  */}
      ...
      <section className="max-w-7xl mx-auto -mt-24 relative z-10 px-8 pb-20 text-agency-navy">
        <div className="bg-white rounded-xl shadow-2xl p-10 border border-gray-100">
          <div className="mb-10">
            ...
            <p className="text-gray-500">Real-time real estate insights in the Texas area</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-100 p-8 rounded-lg">
              <p className="text-gray-500 text-sm mb-2">Median Price</p>
              <p className="text-4xl font-bold mb-3 text-agency-navy">$650K</p>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <p className="text-4xl font-bold mb-3 text-agency-navy">8,900</p>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <p className="text-4xl font-bold mb-3 text-agency-navy">35 Days</p>
              <p className="text-sm font-medium flex items-center gap-1 text-green-700">
      ...
      <section className="max-w-7xl mx-auto px-8 py-16 text-agency-navy">
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-lg">Find the neighborhood that perfectly aligns with your vision and lifestyle in Texas.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <article className="group bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 flex flex-col">
            <div className="relative h-64">
              <img alt="Austin" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBHDdiN_f-NocLtKyix4wLhqrnwqlrk3eKE2qO49rZJ3xoowNwQnH3b4qiTh4BpgsV7xymXf4H1m_8mpYsbgI5je6fOgG_W3JDWM-NYmqrHjSE6jyEsRdUa_9ldl0yspCQ-n1FBdHbSxdFarkBke-5ORjLhx00TL8_MAUnz4RBO567HIc-jgHw0EyhlDEmEgMzcnRxzZ2bZsW-A8JtgeAG_c9sL_2FBCzO4CmaKPYFbaxN27OL-MKaVzZescUC5aPE9SI50Ws8wXlol" />
              <span className="absolute top-4 left-4 bg-agency-navy/80 text-white text-[10px] px-3 py-1 rounded-sm uppercase tracking-widest">Tech Hub</span>
            </div>
            <div className="p-8 flex flex-col flex-grow text-agency-navy">
              <h3 className="text-2xl font-bold mb-4">AUSTIN</h3>
              <p className="text-gray-500 text-sm mb-8 leading-relaxed">Fast-growing tech center with vibrant live music and beautiful hill country.</p>
              <div className="mt-auto">
                <Link to="/properties/21" className="block text-center w-full bg-agency-navy text-white py-3 rounded text-sm font-semibold tracking-wide hover:bg-agency-gold transition-colors">View Listings</Link>
              </div>
            </div>
          </article>
          <article className="group bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 flex flex-col">
            <div className="relative h-64">
              <img alt="Houston" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2U-OnAPOKY4VRGEBz0W1TffHlvS0iGsEdPeo1zYCWMcGnXCzFDnw-WtAHlSVJoEijg_bGteLExeHAGGmNd7h_dorlyOCmcfgtB6gtVaW_sOkPPe2T6BUdQ8_nKGT5VTMVDvYvqr0NZbIREfiBzwrfWcW3UpuBhIy7hkZOmH438ORjBN94umQl-pCFgewDXzBgIRVUKdBeITUqm-1OtYl-y85zubermVOsQ7g-R8HI_rXtXVAJNJSQfmFXgLLEw9vwbwKhNGqzja4a" />
              <span className="absolute top-4 left-4 bg-agency-navy/80 text-white text-[10px] px-3 py-1 rounded-sm uppercase tracking-widest">Global Metropolis</span>
            </div>
            <div className="p-8 flex flex-col flex-grow text-agency-navy">
              <h3 className="text-2xl font-bold mb-4">HOUSTON</h3>
              <p className="text-gray-500 text-sm mb-8 leading-relaxed">Diverse cultural offerings, world-class dining, and extensive luxury estates.</p>
              <div className="mt-auto">
                <Link to="/properties/22" className="block text-center w-full bg-agency-navy text-white py-3 rounded text-sm font-semibold tracking-wide hover:bg-agency-gold transition-colors">View Listings</Link>
              </div>
            </div>
          </article>
          <article className="group bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 flex flex-col">
            <div className="relative h-64">
              <img alt="Dallas" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAvNVYDXl_e2POUUM1D3cIhqOh5Q-D6QgdMkhLTOACfSntDiWM7EXH1jsC3j8Zegg-73LLEFvSxfH1KWsVrZMWXs98eVj7kGFY8JnQTjcnpOox7ltpb0d2G42y5dNrtcxnjQaFatPTSEH8tE6VOBAbvWFSSBUQO6u0uRrnS4KEA0VdhbzsME1YQzQxgZVJeyvaK7zse7Vcdb2hcjo85YAZVuC6AF645yjqEfHTtIr1mQxWL0G8y34s6vJYFoCI2gM5e-OVXzgkzgMKq" />
              <span className="absolute top-4 left-4 bg-agency-navy/80 text-white text-[10px] px-3 py-1 rounded-sm uppercase tracking-widest">Modern Elegance</span>
            </div>
            <div className="p-8 flex flex-col flex-grow text-agency-navy">
              <h3 className="text-2xl font-bold mb-4">DALLAS</h3>
              <p className="text-gray-500 text-sm mb-8 leading-relaxed">Sleek urban lofts, massive suburban compounds, and a robust economy.</p>
              <div className="mt-auto">
                <Link to="/properties/23" className="block text-center w-full bg-agency-navy text-white py-3 rounded text-sm font-semibold tracking-wide hover:bg-agency-gold transition-colors">View Listings</Link>
              </div>
            </div>
          </article>
        </div>
